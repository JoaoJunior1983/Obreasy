        ...
        <div className="bg-white rounded-3xl max-w-xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative">
          ...
          <div className="p-6 sm:p-8 relative z-10">
            ...
            <div className="text-center mb-4">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-full mb-4 shadow-lg animate-[pulse_3s_ease-in-out_infinite]">
            ...
            <div className="space-y-3 max-w-md mx-auto mb-4">
              <button
                onClick={handleCTA}
                className="w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-4 rounded-xl transition-all duration-300 font-bold text-base shadow-lg shadow-blue-600/30 hover:shadow-xl hover:shadow-blue-700/40 flex items-center justify-center gap-2 hover:scale-[1.02] transform animate-[glow_4s_ease-in-out_infinite]"
              >
            ...
            {question.options.map((option) => (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  {quizData[question.field] === option && (
                    <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 ml-3">
