  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] p-4 sm:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        {/* Formulário */}
        <form onSubmit={handleSubmit} className="bg-slate-900/60 rounded-2xl shadow-[0_4px_20px_rgb(0,0,0,0.3)] p-6 sm:p-8 space-y-6 relative overflow-hidden border border-slate-800/50">
          {/* Dados da Obra */}
          <div className="space-y-4 relative z-10">
            ...
            <div className="space-y-2">
              <Label htmlFor="nome" className="text-sm text-gray-300 font-medium">
                Nome da Obra *
              </Label>
              <Input
                id="nome"
                ...
                required
                className="bg-slate-800 border-slate-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
            ...
            {/* Área */}
            <div className="space-y-2">
              <Label htmlFor="area" className="text-sm text-gray-300 font-medium">
                Área em m² *
              </Label>
              <Input
                id="area"
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {/* Estado */}
              <div className="space-y-2">
                <Label htmlFor="estado" className="text-sm text-gray-300 font-medium">
                  Estado *
                </Label>
                <Select
              ...
              <div className="space-y-2 sm:col-span-2">
                <Label htmlFor="cidade" className="text-sm text-gray-300 font-medium">
                  Cidade *
                </Label>
                <Input
                  id="cidade"
            ...
            {/* Bairro */}
            <div className="space-y-2">
              <Label htmlFor="bairro" className="text-sm text-gray-300 font-medium">
                Bairro *
              </Label>
              <Input
                id="bairro"
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="space-y-2">
              <Label htmlFor="orcamento" className="text-sm text-gray-300 font-medium">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-12 bg-slate-800 border-slate-700 text-white placeholder:text-gray-500 focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Data de Início */}
              <div className="space-y-2">
                <Label htmlFor="dataInicio" className="text-sm text-gray-300 font-medium">
              ...
              {/* Previsão de Término */}
              <div className="space-y-2">
                <Label htmlFor="dataTermino" className="text-sm text-gray-300 font-medium">
