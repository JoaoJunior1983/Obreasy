  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center p-4">
      <div className="max-w-2xl w-full text-center">
        ...
        {/* Texto principal */}
        <p className="text-2xl sm:text-3xl text-gray-400 mb-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <button 
            ...
            className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-10 py-5 rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transform inline-flex items-center gap-3 w-full sm:w-auto"
          >
          ...
          <button 
            ...
            className="bg-slate-800 border-2 border-slate-600 text-gray-300 px-10 py-5 rounded-xl hover:bg-slate-700 hover:text-white transition-all font-bold text-lg shadow-md hover:shadow-lg hover:scale-105 transform inline-flex items-center gap-3 w-full sm:w-auto"
          >
